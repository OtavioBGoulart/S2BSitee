...
export function Costing({ setModule }: ModulesProps) {
            ...
            <ProductsContainer>
                <CardsContainer>
                    <Card>
                        ...
                        <span>Controle de Posição Financeira do Cliente</span>
                    </Card>
                    <Card>
                        <img src="/iot.png" />
                    ...
                    <Card>
                        ...
                        <span>Importação de Arquivos de Remessa</span>
                    </Card>
                    <Card>
                        <img src="/fita-metrica.png" />
                        <span>Controle de do Cliente</span>
                    </Card>
                    <Card>
                        <img src="/melhoria.png" />
                        <span>Acompahamento do Crédito</span>
                    </Card>
                    <Card>
                        <img src="/melhoria.png" />
